    ...
    <div className="min-h-screen bg-app-gradient">
      <div className="mx-auto flex min-h-screen max-w-[1480px]">
        ...
        <div className="min-w-0 flex-1 pb-24 lg:pb-10">
          <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl lg:hidden"><div className="flex h-16 items-center justify-between px-4 sm:px-6"><ValidaLogo variant="compact" /><a href="/" className="text-xs font-bold text-slate-500 hover:text-brand">Community</a></div></header>
          <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
            <section className="overflow-hidden rounded-3xl border border-white/80 bg-gradient-to-br from-white via-white to-blue-50 p-5 shadow-card sm:p-8">
