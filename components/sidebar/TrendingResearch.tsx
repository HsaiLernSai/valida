    ...
    <Card as="section" className="p-4">
      ...
      <div className="mt-3 space-y-3">
        {trendingResearch.map((item, index) => (
          <a href={discoveryUrl({ query: item.query })} key={item.title} className="group flex min-h-11 items-start gap-3 rounded-xl px-1 py-1.5 transition hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand/15">
